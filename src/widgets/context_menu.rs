...
impl ContextMenu {
    ...
    pub fn attach<T>(ui: &mut Ui<T>, resp: &Response) -> Self {
    ...
    pub fn is_open<T>(ui: &Ui<T>, for_id: WidgetId) -> bool {
...
impl MenuItem {
    ...
    #[track_caller]
    pub fn separator<T>(ui: &mut Ui<T>) -> Response {
        ...
        element.set_align(Align::h(HAlign::Stretch));
    ...
    pub fn show<T>(self, ui: &mut Ui<T>, popup: &PopupHandle) -> Response {
        ...
        element.set_align(Align::h(HAlign::Stretch));
        element.set_justify(Justify::SpaceBetween);
        element.padding = padding;
        element.set_gap(16.0);
