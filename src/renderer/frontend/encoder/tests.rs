...
fn text_shape_emits_draw_text() {
    ...
    ui.shared.render.text.evict_cosmic_buffers(0);
    assert!(
        !ui.shared.render.text.has_cosmic_buffer(key),
    ...
    ui.shared.render.text.evict_cosmic_buffers(0);
    let measure_calls = ui.shared.render.text.measure_calls();
    ui.request_repaint();
    ui.run_at_acked(UVec2::new(200, 200), body);
    ...
    assert!(
        !ui.shared.render.text.has_cosmic_buffer(replayed_key),
    ...
    assert!(ui.shared.render.text.has_cosmic_buffer(replayed_key));
}
