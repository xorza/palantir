...
//! [`crate::gpu::quad_pipeline::QuadPipeline`] but draws indexed
...
//! always stamped by [`QuadPipeline`](crate::gpu::quad_pipeline::QuadPipeline)'s
...
//! [`crate::gpu::image_pipeline::ImagePipeline`].
