...
/// separate from [`Backbuffer`](crate::gpu::backbuffer::Backbuffer) so the direct-present path can have a stencil
...
impl Stencil {
    ...
    /// the terms
    /// [`Backbuffer::ensure`](crate::gpu::backbuffer::Backbuffer::ensure)
    /// states.
