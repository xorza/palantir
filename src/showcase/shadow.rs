...
fn chrome_cell<T>(ui: &mut Ui<T>, id: &'static str, bg: Background) {
    Panel::zstack()
        .id_salt(id)
        .size((Sizing::FILL, Sizing::FILL))
        .padding(24.0)
