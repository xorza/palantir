...
fn bench(c: &mut Criterion) {
    ...
    group.bench_function("measure/cached", |b| {
        let mut ui = Ui::new();
        let _ = ui.run_frame(display, std::time::Duration::ZERO, build);
        b.iter(|| {
            black_box(ui.run_frame(display, std::time::Duration::ZERO, build));
        });
    });
    ...
    group.bench_function("scroll/idle", |b| {
        let mut ui = Ui::new();
        let _ = ui.run_frame(display, std::time::Duration::ZERO, build_scrolling);
        b.iter(|| {
            black_box(ui.run_frame(display, std::time::Duration::ZERO, build_scrolling));
        });
    });
    ...
    group.bench_function("heavy/measure/cached", |b| {
        ...
        let _ = ui.run_frame(display, std::time::Duration::ZERO, build_heavy);
        b.iter(|| {
            black_box(ui.run_frame(display, std::time::Duration::ZERO, build_heavy));
        });
    });
    ...
    group.bench_function("dense/measure/cached", |b| {
        let mut ui = Ui::new();
        let _ = ui.run_frame(display, std::time::Duration::ZERO, build_dense);
        b.iter(|| {
            black_box(ui.run_frame(display, std::time::Duration::ZERO, build_dense));
        });
    });
